<div>
    <div>
        ...
        <div class="flex">
            <span class="bold gray mr4 no-wrap fs12">Reply :</span>
    ...
    <div class="flex mt8" style="margin-left: 24px">
        ...
        <div style="margin-top: 2px">
            <div class="flex">
                <span class="bold gray fs12 mt4">Thread</span>
            </div>
            <div class="toggle-box relative">
                <div class="fs12 toggle-container-button flex align-center">
                    <span class="blue bold pointer fs11">show parent thread</span>
                ...
                <div class="mt8 toggle-container">
                    <div class="flex">
                        ...
                        <div class="mb8">
                            ...
                            <div class="mt8">
                                <div class="flex">
                                    <span class="bold fs12 lblack no-wrap mr4" style="margin-top: 3px">subject :</span>
                                    <a href="{{ $thread->link }}" class="blue no-underline bold">
                                        <span class="fs15">{!! $thread->mediumslice !!}</span>
                                    </a>
                                </div>
                                <div class="flex mt4">
                                    <span class="bold fs12 lblack no-wrap mr4">content :</span>
                                    <div class="expand-box" style="margin-top: -1px;">
