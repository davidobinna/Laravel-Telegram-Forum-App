<div>
    ...
    <div class="ml8">
        ...
        <div class="my8 py4 toggle-box">
            <div class="px8 flex align-center forumslist-categories-load toggle-container-button pointer unselectable">
                <input type="hidden" class="forum" value="{{ $forum->id }}">
            ...
            <div class="toggle-container forumslist-categories px8">
                <div class="relative br3 hidden-overflow my8" style="width: 156px; height: 17px; margin-left: 30px">
                    <div class="fade-loading"></div>
                </div>
                <div class="relative br3 hidden-overflow my8" style="width: 170px; height: 17px; margin-left: 30px">
                    <div class="fade-loading"></div>
                </div>
                <div class="relative br3 hidden-overflow mt8" style="width: 130px; height: 17px; margin-left: 30px">
                    <div class="fade-loading"></div>
                </div>
            </div>
        </div>    
