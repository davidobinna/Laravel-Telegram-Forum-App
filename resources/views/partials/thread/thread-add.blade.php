...
<div id="thread-add-wrapper" class="thread-add-container">
        ...
        <div class="relative">
            <div>
                <div class="flex align-center forum-color button-with-suboptions pointer thread-add-posted-to fs12">
                    ...
                    <svg class="size14 thread-add-forum-icon mr8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div class="suboptions-container thread-add-suboptions-container width-max-content y-auto-overflow" style="max-height: 236px;">
                    @foreach($forums as $forum)
                        @php $status = $forum->status; @endphp
                        @if($status->slug == 'live')
                        <div class="thread-add-suboption thread-add-select-forum flex align-center full-width mb2">
                            <div class="relative size14 mr8">
                                <svg class="size14 forum-ico icon-above-spinner" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    {!! $forum->icon !!}
                                </svg>
                                <svg class="spinner size14 opacity0 absolute black" style="top: 0; left: 0" fill="none" viewBox="0 0 16 16">
                                    <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke"></circle>
                                    <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke"></path>
                                </svg>
                            </div>
                            <span class="thread-add-forum-val unselectable">{{ __($forum->forum) }}</span>
                            <input type="hidden" class="forum-id" value="{{ $forum->id }}">
                        </div>
                        @else
                        <div class="thread-add-suboption flex full-width cursor-not-allowed">
                            <div class="relative size14 mr8 mt2">
                                <svg class="size14 forum-ico icon-above-spinner" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    {!! $forum->icon !!}
                                </svg>
                                <svg class="spinner size14 opacity0 absolute black" style="top: 0; left: 0" fill="none" viewBox="0 0 16 16">
                            ...
                            <div>
                                <div class="flex align-center">
                                    ...
                                    <span class="fs13 bold category-status unselectable @if($status->slug=='closed') red @endif">{{ $status->status }}</span>
                                </div>
                                @if($status->slug == 'closed')
                                <span class="fs10 gray block">{{ __('This forum is closed by admins') }}</span>
                                @else
                                @endif
                            </div>
                            <input type="hidden" class="forum-id" value="{{ $forum->id }}">
                ...
                <div class="suboptions-container thread-add-suboptions-container width-max-content y-auto-overflow" style="max-height: 236px;">
                    <div class="thread-add-categories-container">
                        @foreach($categories as $c)
                            @php 
                                $status = $c->status; 
                                $isclosed = $status->slug == 'closed';
                            @endphp

                            <div class="thread-add-suboption @if($isclosed) stop-propagation cursor-not-allowed @else thread-add-select-category @endif @if($c->slug == $category->slug) selected-category @endif">
                                <div class="flex align-center">
                                    <span class="category-name">{{ __("$c->category") }}</span>
                                    @if($status->slug != 'live')
                                    <div class="status-section">
                                        <div class="flex align-center">
                                            <div class="gray height-max-content mx4 fs10">•</div>
                                            <span class="fs13 bold category-status @if($isclosed) red @endif">{{ __($status->status) }}</span>
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                <input type="hidden" class="category-id" autocomplete="off" value="{{ $c->id }}">
                            </div>
                        @endforeach
                    </div>
                    <div class="thread-add-suboption thread-add-select-category thread-add-category-skeleton none">
                        <div class="flex align-center">
                            <span class="category-name unselectable"></span>
                            <div class="status-section none">
                                <div class="flex align-center">
                                    <div class="gray height-max-content mx4 fs10">•</div>
                                    <span class="fs13 bold category-status unselectable"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="nested-soc thread-add-suboptions-container" style="right: 0; min-width: unset; width: max-content; z-index: 2">
                            <div class="thread-add-suboption thread-add-visibility flex align-center">
                                <svg class="size15 mr8" style="fill: #202020" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256,8C119,8,8,119,8,256S119,504,256,504,504,393,504,256,393,8,256,8ZM456,256a199.12,199.12,0,0,1-10.8,64.4H424.9a15.8,15.8,0,0,1-11.4-4.8l-32-32.6a11.92,11.92,0,0,1,.1-16.7l12.5-12.5v-8.7a11.36,11.36,0,0,0-3.3-8l-9.4-9.4a11.36,11.36,0,0,0-8-3.3h-16a11.31,11.31,0,0,1-8-19.3l9.4-9.4a11.36,11.36,0,0,1,8-3.3h32a11.35,11.35,0,0,0,11.3-11.3v-9.4a11.35,11.35,0,0,0-11.3-11.3H362.1a16,16,0,0,0-16,16v4.5a16,16,0,0,1-10.9,15.2l-31.6,10.5a8,8,0,0,0-5.5,7.6v2.2a8,8,0,0,1-8,8h-16a8,8,0,0,1-8-8,8,8,0,0,0-8-8H255a8.15,8.15,0,0,0-7.2,4.4l-9.4,18.7a15.92,15.92,0,0,1-14.3,8.8H202a16,16,0,0,1-16-16V199a16.06,16.06,0,0,1,4.7-11.3l20.1-20.1a24.74,24.74,0,0,0,7.2-17.5,8,8,0,0,1,5.5-7.6l40-13.3a11.64,11.64,0,0,0,4.4-2.7l26.8-26.8a11.31,11.31,0,0,0-8-19.3H266l-16,16v8a8,8,0,0,1-8,8H226a8,8,0,0,1-8-8v-20a8.05,8.05,0,0,1,3.2-6.4l28.9-21.7c1.9-.1,3.8-.3,5.7-.3C366.3,56,456,145.7,456,256ZM138.1,149.1a11.36,11.36,0,0,1,3.3-8l25.4-25.4a11.31,11.31,0,0,1,19.3,8v16a11.36,11.36,0,0,1-3.3,8l-9.4,9.4a11.36,11.36,0,0,1-8,3.3h-16A11.35,11.35,0,0,1,138.1,149.1Zm128,306.4v-7.1a16,16,0,0,0-16-16H229.9c-10.8,0-26.7-5.3-35.4-11.8l-22.2-16.7a45.42,45.42,0,0,1-18.2-36.4V343.6a45.44,45.44,0,0,1,22.1-39l42.9-25.7a46.1,46.1,0,0,1,23.4-6.5h31.2a45.62,45.62,0,0,1,29.6,10.9l43.2,37.1h18.3a31.94,31.94,0,0,1,22.6,9.4l17.3,17.3a18.32,18.32,0,0,0,12.9,5.3H431A199.64,199.64,0,0,1,266.1,455.5Z"/></svg>
                                <span class="fs12 bold lblack">{{ __('Public') }}</span>
                                <input type="hidden" class="thread-visibility" value="public">
                                <input type="hidden" class="thread-visibility-name" value="{{ __('Public') }}" autocomplete="off">
                            ...
                            <div class="thread-add-suboption thread-add-visibility flex align-center">
                                ...
                                <span class="fs12 bold lblack">{{ __('Followers Only') }}</span>
                                <input type="hidden" class="thread-visibility" value="followers-only">
                                <input type="hidden" class="thread-visibility-name" value="{{ __('Followers Only') }}" autocomplete="off">
                            ...
                            <div class="thread-add-suboption thread-add-visibility flex align-center">
                                ...
                                <span class="fs12 bold lblack">{{ __('Private') }}</span>
                                <input type="hidden" class="thread-visibility" value="private">
                                <input type="hidden" class="thread-visibility-name" value="{{ __('Private') }}" autocomplete="off">
                    ...
                    <div class="relative">
                        ...
                        <div class="nested-soc thread-add-suboptions-container" style="right: 0; width: max-content; min-width: unset">
                            ...
                            <div class="thread-add-suboption thread-add-type-change tap-poll flex align-center">
                                ...
                                <input type="hidden" class="thread-type-name" value="{{ __('Poll') }}">
    ...
    <div id="thread-add-discussion">
        <div>
            <div class="flex space-between mb4 mx8">
                ...
                <div class="custom-checkbox-button pointer disable-announcement-replies flex align-center">
                    <div class="custom-checkbox size10 mr4" style='border-radius: 2px;'>
                        ...
                        <input type="hidden" id="disable-replies" class="checkbox-status" autocomplete="off" value="0">
                    </div>
            ...
            <textarea name="content" id="content" placeholder="{{ __('Your post content') }}.."></textarea>
        </div>
        <div class="thread-add-media-section px8">
            ...
            <div class="flex align-end">
                ...
                <div class="progress-bar-box none pb4" style="margin-left: 18px; flex: 1;">
    ...
    <div class="thread-add-share typical-button-style full-center border-box" style="padding: 12px 0; margin: 10px;">
        ...
        <span class="bold unselectable">{{ __('Share post') }}</span>
        <input type="hidden" class="success-message" value="{{ __('Your post has been shared successfully to your timeline') }}" autocomplete="off">
    </div>
    <style>
        .CodeMirror,
        .CodeMirror-scroll {
