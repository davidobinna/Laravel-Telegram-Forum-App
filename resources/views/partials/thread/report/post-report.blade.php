<div class="report-resource-container none" id="post-report-container">
    <input type="hidden" class="reportable-id" value="" autocomplete="off">
    <input type="hidden" class="reportable-type" value="post" autocomplete="off">
    ...
    <div class="report-section">
        ...
        <div>
            ...
            <label class="resource-report-option">
                <input type="radio" name="report" value="not-a-reply" class="height-max-content report-choice-input" autocomplete="off">
                <div class="ml8">
                    <p class="bold no-margin">{{__('not a reply')}}</p>
                    <p class="no-margin gray">{{__('This was posted as an answer, but it is irrelevent and does not add anything useful to the post. It should possibly be an edit, a comment, or deleted altogether')}}.</p>
                </div>
            </label>
            <label class="resource-report-option has-child-to-be-opened">
                ...
                <div class="ml8">
                    ...
                    <div class="child-to-be-opened">
                        ...
                        <input type="hidden" class="first-phrase-text" value="{{ __('Enter at least 10 characters') }}" autocomplete="off">
                        <input type="hidden" class="more-to-go-text" value="{{ __('more to go') }}." autocomplete="off">
                        <input type="hidden" class="chars-left-text" value="{{ __('characters left') }}" autocomplete="off">
                        <input type="hidden" class="too-long-text" value="{{ __('Too long by ') }}" autocomplete="off">
                        <input type="hidden" class="characters-text" value="{{ __('characters') }}" autocomplete="off">
                    </div>
                </div>
            </label>
        </div>
        ...
        <div class="flex align-center" style="margin-top: 12px">
            <div id="submit-post-report-button" class="blue-button-style disabled-blue-button-style submit-report-button flex align-center">
