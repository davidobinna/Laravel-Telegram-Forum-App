...
@section('content')
    ...
    <div class="full-center" style="height: 460px">
        <div style="display: flex; flex-direction: column; align-items: center;" class="error-container">
            ...
            <h1 class="fs26 no-margin my8 error-message">{{__('This account is currently banned')}}</h1>
