...
@section('title', 'Archives - Forums')

@section('left-panel')
    @include('partials.admin.left-panel', ['page'=>'admin.archives', 'subpage'=>'admin-archives-forums'])
@endsection
...
@section('content')
    ...
    <div class="flex space-between align-center top-page-title-box">
        <div class="flex align-center">
            ...
            <h1 class="fs22 no-margin lblack">{{ __('Archives - Forums') }}</h1>
        </div>
        <div class="flex align-center height-max-content">
            ...
            <div class="flex align-center">
                <span class="fs13 bold">{{ __('Archives management - Forums') }}</span>
            </div>
        </div>
    </div>
    <div id="admin-main-content-box">
        @if($candelete)
        <div id="delete-archived-forum-viewer" class="global-viewer full-center none">
            ...
            <div class="viewer-box-style-1">
                <div class="flex align-center space-between light-gray-border-bottom" style="padding: 14px;">
                    <div class="flex align-center">
                        ...
                        <span class="fs20 bold forum-color">{{ __('Delete Archived Forum') }}</span>
                    </div>
        ...
        <p class="fs13 lblack my8">This section concerns archived forums and different operation on them like <strong>permanent delete</strong> and <strong>links to restore</strong> ..etc.</p>
        @if(!$candelete)
        <div class="section-style flex align-center my8">
            ...
            <p class="fs12 bold lblack no-margin">You are not able to delete forums due to lack of permisssion. If you think one of the archived forums should be deleted altogether, please contact a super admin.</p>
        </div>
        @endif
        <div>
                    ...
                    <tr class="forum-row">
                        ...
                        <td>
                            <div class="expand-box fs13">
                                <span class="bold mr4">Description:</span> 
                                <span class="expandable-text my4 forum-description" style="line-height: 1.4">{{ $forum->description_slice }}</span>
                            ...
                            <div class="my8 fs13">
                                <div class="ml8">
                                    <div class="flex align-center mb8">
                                        ...
                                        <p class="no-margin bold">Total forum threads : {{ $forum->statistics('total-threads-count') }}</p>
                                    </div>
                                    <div class="flex align-center mb8">
                                        ...
                                        <p class="no-margin bold">Total forum replies : {{ $forum->statistics('total-posts-count') }}</p>
                                    </div>
                                    <div>
                                        <div class="flex">
                                            <div class="flex align-center height-max-content">
                        ...
                        <td>
                            ...
                            @if($candelete)
                            <div class="open-delete-archived-forum-dialog red-button-style full-center no-underline black mt4" style="padding: 5px 12px;">
                                ...
                                <input type="hidden" class="forum-id" autocomplete="off" value="{{ $forum->id }}">
                            </div>
                            @else
